...
<body>
    ...
    <p class = "introTextIndent">Welcome to the InfoLearn app. It is not a secret for anyone that “repetition is the mother of learning”
        and in this application this particular technique is used to memorize information.<br><span class = "introTextIndent">German psychologist
        Herman Ebbingaus has determined the optimal intervals for repeating information for effective memorization.
            This application is designed to facilitate the organization of periodic repetition.</span></p>

    <h4 class = "introTextIndent">Instruction for use:</h4>
    <ol>
    ...
    <p class = "introTextIndent">I hope with the help of this application you can improve the quality of memorization of the studied material,
        and I also wish you not to forget that “you can’t easily catch and the fish from the pond ":)</p>
    <p class = "introTextIndent">P.S. Thanks to Alexander Terekhov for help in learning programming and for being a very good friend.</p>
</body>
</@c.page>