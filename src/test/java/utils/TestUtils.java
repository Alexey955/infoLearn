...
public class TestUtils {
    ...
    private static String strDatePriorRep = datePriorRep.format(DateTimeFormatter.ofPattern("dd.MM.yyyy"));
    private static String strDateNextRep = dateNextRep.format(DateTimeFormatter.ofPattern("dd.MM.yyyy"));
